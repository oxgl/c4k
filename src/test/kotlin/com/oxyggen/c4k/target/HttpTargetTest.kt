...
internal class HttpTargetTest {
    ...
    fun `returns correct normalized Url`() {
        ...
        Assertions.assertEquals(url.getComparableUrl(true), "https://user@test.com/index.htm?query=abc#last")
        Assertions.assertEquals(url.getComparableUrl(false), "user@test.com/index.htm?query=abc#last")
    }
